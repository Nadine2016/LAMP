...
When you apply the template and your LAMP resources are successfully provisioned in IBM CLoud, you see the public IP address that is assigned to your virtual server instance in your Schematics log files. You can use the IP address to access your instance from the internet.
